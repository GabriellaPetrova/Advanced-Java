package DefiningClases.FamilyTree;
...
public class Person {
    ...
    public String toString() {
        return  this.name + " " + this.birthday + System.lineSeparator() +
                ...
                ((this.parents.isEmpty()) ? "" : this.parents.values().stream()
                        .map(Person::printParentsEndChildren)
                        .collect(Collectors.joining(System.lineSeparator()))
                        + System.lineSeparator())
                + "Children:" + System.lineSeparator() +
                ((this.children.isEmpty()) ? "" : this.children.values().stream()
                        .map(Person::printParentsEndChildren)
                        .collect(Collectors.joining(System.lineSeparator())));
    }
